...
public class EntityGrant:Codable{
    ...
    public init(data: [String : JSONObject]? = nil, id: UUID? = nil, insertInstant: Date? = nil, lastUpdateInstant: Date? = nil, permissions: [String]? = nil, recipientEntityId: UUID? = nil, userId: UUID? = nil) {
        self.data = data
        self.id = id
