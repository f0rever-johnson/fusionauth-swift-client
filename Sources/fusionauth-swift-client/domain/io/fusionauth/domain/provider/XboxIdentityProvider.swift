...
public struct XboxIdentityProvider:Codable, BaseIdentityProvider{

    public typealias D = XboxApplicationConfiguration
    
    //BaseIdentityProvider protocol requirements
    public var applicationConfiguration: [String : XboxApplicationConfiguration]? = nil
