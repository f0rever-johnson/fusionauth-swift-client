...
public class OAuth2Configuration:Codable{
    ...
    public init(authorizedOriginURLs: [String]? = nil, authorizedRedirectURLs: [String]? = nil, clientId: String? = nil, clientSecret: String? = nil, deviceVerificationURL: String? = nil, enabledGrants: [GrantType]? = nil, generateRefreshTokens: Bool? = nil, logoutURL: URL? = nil, requireClientAuthentication: Bool? = nil) {
