...
public class CORSConfiguration:Codable, Enableable{
    ...
    public init(allowCredentials: Bool? = nil, allowedHeaders: [String]? = nil, allowedMethods: [HTTPMethod]? = nil, allowedOrigins: [String]? = nil, exposedHeaders: [String]? = nil, preflightMaxAgeInSeconds: Int? = nil, enabled: Bool? = nil) {
