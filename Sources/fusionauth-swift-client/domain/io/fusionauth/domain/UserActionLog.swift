...
public struct UserActionLog:Codable {
    ...
    public init(actioneeUserId: UUID? = nil, actionerUserId: UUID? = nil, applicationIds: [UUID]? = nil, comment: String? = nil, createInstant: Date? = nil, emailUserOnEnd: Bool? = nil, endEventSent: Bool? = nil, expiry: Date? = nil, history: LogHistory? = nil, id: UUID? = nil, localizedName: String? = nil, localizedOption: String? = nil, localizedReason: String? = nil, name: String? = nil, notifyUserOnEnd: Bool? = nil, option: String? = nil, reason: String? = nil, reasonCode: String? = nil, userActionId: UUID? = nil) {
